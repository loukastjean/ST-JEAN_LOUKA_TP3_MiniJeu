...
public class MenuManager : MonoBehaviour
{
    ...
    [Header("Buttons")] [SerializeField] private Button btnPlay;
    ...
    private List<Button> player1Characters;
    ...
    private void StartGame()
    {
        ...
        var player1 = Instantiate(prefabs[player1SelectedIndex], new Vector2(-8, 1), Quaternion.identity)
            .GetComponent<Personnage>();

        // Instantiate Player 2
        var player2 = Instantiate(prefabs[player2SelectedIndex], new Vector2(8, 1), Quaternion.identity)
            .GetComponent<Personnage>();
